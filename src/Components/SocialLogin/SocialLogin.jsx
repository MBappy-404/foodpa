    ...
    <div>
      <div className="mt-3">
        ...
        <div className=" flex justify-start space-x-4 ">
          <button onClick={handleGoogleSignIn} type="button" className="py-2.5 px-4 text-sm font-semibold rounded text-blue-500 bg-blue-100 hover:bg-blue-200 focus:outline-none">
          ...
          <button onClick={handleFacebookSignIn} type="button" className="py-2.5 px-4 flex gap-4 text-sm font-semibold rounded text-blue-500 bg-blue-100 hover:bg-blue-200 focus:outline-none">
