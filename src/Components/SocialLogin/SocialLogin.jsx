    ...
    <div>
      <div className="mt-3">
        ...
        <div className=" flex justify-start space-x-4 ">
          {/* Google login  */}
          <button onClick={handleGoogleSignIn} type="button" className="py-2.5 px-4 flex justify-center gap-3 text-sm font-semibold rounded text-gray-500 bg-gray-200 hover:bg-gray-300 transition-all duration-300 focus:outline-none">
            {/* Google Log In    */}
            {
              !loginError && googleLoading ?
                // Loading Spinner
                <span className="block"><RotatingLines
                  visible={true}
                  height="20"
                  width="20"
                  strokeColor="gray"
          ...
          {/* Facebook login    */}
          <button onClick={handleFacebookSignIn} type="button" className="py-2.5 px-4 flex gap-4 text-sm font-semibold rounded text-gray-500 bg-gray-200 hover:bg-gray-300 transition-all duration-300 focus:outline-none">
            {
              !loginError && facebookLoading ?
                // Loading Spinner 
                <span className="block"><RotatingLines
                  visible={true}
                  height="20"
