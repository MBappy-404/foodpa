                  ...
                  cart?.length ? <>
                        ...
                        <tr key={item._id} className=" border-b">
                          ...
                          <td className=" py-3 px-4">
                            <div className="flex divide-x border w-max">
                              <button onClick={handleDecrease} type="button" className="bg-gray-100 px-4 py-2 font-semibold">
                              ...
                              <button onClick={handleIncrease} type="button" className="bg-gray-800 text-white px-4 py-2 font-semibold">
                    ...
                    <td className=" py-3 px-4">
                      <div className="flex divide-x border w-max">
                        ...
                        <div className="bg-transparent px-4 py-2 font-semibold text-[#333] text-md w-10 h-6 "></div>
          ...
          </div>
          {
            ...
            <div className=" max-w-sm transition-all  bg-gray-100 p-3  duration-500 ml-auto">
              <ul className="text-[#333] divide-y">
                <li className="flex flex-wrap gap-4 text-md py-3">Subtotal <span className="ml-auto font-bold">${totalPrice}</span></li>
                <li className="flex flex-wrap gap-4 text-md py-3">Discount <span className="ml-auto font-bold">$0.00</span></li>
                <li className="flex flex-wrap gap-4 text-md py-3">Tax <span className="ml-auto font-bold">$0.00</span></li>
                <li className="flex flex-wrap gap-4 text-md py-3 font-bold">Total <span className="ml-auto">${totalPrice}</span></li>
              </ul>
              <button onClick={() => setOpenModal(true)} type="button" className="mt-6 text-md px-6 py-2.5 w-full bg-[#FFA200] hover:bg-[#222]  transition-all duration-500 text-white rounded">Check
                out</button>
            </div>
