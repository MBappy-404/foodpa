               ...
               {accordions.map((PerAccordion, idx) => (
                  <div key={idx} className="p-4 border-b">
                     ...
                     >
                        ...
                        <svg
                           className="fill-[#FFA200] shrink-0 ml-8"
                           width="16"
                           height="16"
                        ...
                        >
                           <rect
                              ...
                              height="2"
                              rx="1"
                              className={`transform origin-center transition duration-200 ease-out ${isOpen === idx && "!rotate-180"}`}
                           />
                           <rect
                              y="7"
                              width="16"
                              height="2"
                              rx="1"
                              className={`transform origin-center rotate-90 transition duration-200 ease-out ${isOpen === idx && "!rotate-180"}`}
                           />
                        </svg>
                     </button>
                     <div
